...
// #[test_case(test_roqoqo_1_7::operations::PragmaAnnotedOp::new(test_roqoqo_1_7::operations::Operation::from(test_roqoqo_1_7::operations::PauliX::new(0))), "test".to_string()).into(); "PragmaAnnotatedOp"]
