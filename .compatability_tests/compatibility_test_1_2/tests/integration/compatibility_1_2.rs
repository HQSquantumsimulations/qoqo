...
#[test_case(test_roqoqo_1_2::operations::ControlledPhaseShift::new(0,1, 1.0.into()).into(); "ControlledPhaseShift")]
...
#[test_case(test_roqoqo_1_2::operations::PhaseShiftedControlledPhase::new(0,1, 0.5.into(), 1.0.into()).into(); "PhaseShiftedControlledPhase")]
