...
fn test_pyo3_init() {
    ...
    Python::attach(|py| {
        ...
        let br = binding.cast::<DecoherenceOnGateModelWrapper>().unwrap();
        let br_copied = br
...
fn test_to_from_json() {
    ...
    Python::attach(|py| {
        ...
        let deserialised = binding.cast::<DecoherenceOnGateModelWrapper>().unwrap();
        assert_eq!(
            format!("{:?}", br.borrow()),
...
fn test_two_qubit_noise_term() {
    ...
    Python::attach(|py| {
        ...
        let br = br
            ...
            .unwrap();
        let operator = br
            .cast::<DecoherenceOnGateModelWrapper>()
            .unwrap()
